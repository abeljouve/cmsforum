  ...
  if (isset($_POST["confirmation"]) && isset($_POST["email"])) {
    ...
    if ($stmt->rowCount()>0) {
      ...
      if (md5($_POST["password"])==$res["password"]) {
        ...
        $profile_img = "https://www.gravatar.com/avatar/".md5(strtolower(trim($res["email"])))."?d=".urlencode("http://cmsforum.abeljouve.fr/libraries/assets/img/default.jpg")."&s=64";
          ...
          <form class="modal-form" action="#" method="post">
            ...
            if (isset($_POST["confirm-code"])) {
              if (strtoupper($_POST["confirm-code"])==$_SESSION["temp_confirm_code"]) {
                $profile_img = "https://www.gravatar.com/avatar/".md5(strtolower(trim($_SESSION["temp_email"])))."?d=".urlencode("http://cmsforum.abeljouve.fr/libraries/assets/img/default.jpg")."&s=64";
